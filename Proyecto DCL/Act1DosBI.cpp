...
System::Void Proyecto_DCL::Act1DosBI::inicializarTam() {
...
System::Void Proyecto_DCL::Act1DosBI::comprobarRespuestas() {
...
System::Void Proyecto_DCL::Act1DosBI::btnVolver_Click(System::Object^  sender, System::EventArgs^  e) {
	//hiloAct->Abort();
	Advertencia^ ventana = gcnew Advertencia("etapaUno", this, false, manejadorBD);
	ventana->ShowDialog();
}
vector<TiempoMI*> Proyecto_DCL::Act1DosBI::obtenerTiempoItems() {
...
System::Void Proyecto_DCL::Act1DosBI::btnListo_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	...
	string stringPir = "PI" + stringBtn2 + "AÑA";
...
System::Void Proyecto_DCL::Act1DosBI::btnVolver_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver + 5, hVolver + 5);
}
System::Void Proyecto_DCL::Act1DosBI::btnVolver_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver, hVolver);
}
System::Void Proyecto_DCL::Act1DosBI::btnListo_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo + 5, hListo + 5);
}
System::Void Proyecto_DCL::Act1DosBI::btnListo_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo, hListo);
}
System::Void Proyecto_DCL::Act1DosBI::btnAyuda_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda + 5, hAyuda + 5);
}
System::Void Proyecto_DCL::Act1DosBI::btnAyuda_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda, hAyuda);
}
System::Void Proyecto_DCL::Act1DosBI::sonidoInicial() {
	//PlaySound(TEXT("Audios/Oceano/actividad_1.wav"), NULL, SND_ASYNC);
}
System::Void Proyecto_DCL::Act1DosBI::btnAyuda_Click(System::Object^  sender, System::EventArgs^  e) {
	//sonidoInicial();
	this->contAyuda++;
}
System::Void Proyecto_DCL::Act1DosBI::picCerrar_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	Application::Exit();
}
System::Void Proyecto_DCL::Act1DosBI::picMinimizar_Click(System::Object^  sender, System::EventArgs^  e) {
	this->WindowState = FormWindowState::Minimized;
}
System::Void Proyecto_DCL::Act1DosBI::timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	this->Opacity += .1;
	//Detener el timer
	if (this->Opacity == 1) {
		this->timer1->Stop();
...
System::Void Proyecto_DCL::Act1DosBI::Act1DosBI_Load(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
...
System::Void Proyecto_DCL::Act1DosBI::Act1DosBI_Activated(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
}
System::Void Proyecto_DCL::Act1DosBI::Act1DosBI_Deactivate(System::Object^  sender, System::EventArgs^  e) {
	if (this->WindowState == FormWindowState::Minimized) {
		this->Opacity = 0;
	}
}
System::Void Proyecto_DCL::Act1DosBI::tiempo_respuesta(int numItem, TiempoGUI^ tr_item, System::Windows::Forms::Button^ btn)
{
...
System::Void Proyecto_DCL::Act1DosBI::inicializarColor1() {
...
System::Void Proyecto_DCL::Act1DosBI::inicializarColor2() {
...
System::Void Proyecto_DCL::Act1DosBI::inicializarColor3() {
...
System::Void Proyecto_DCL::Act1DosBI::inicializarColor4() {
...
System::Void Proyecto_DCL::Act1DosBI::btn1T_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn1R_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn1L_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn2M_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn2R_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn2S_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn3A_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn3I_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn3O_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn4A_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn4O_Click(System::Object^  sender, System::EventArgs^  e) {
...
System::Void Proyecto_DCL::Act1DosBI::btn4E_Click(System::Object^  sender, System::EventArgs^  e) {
